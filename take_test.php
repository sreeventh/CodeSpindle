                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($res)) {
                        ...
                        <tr>
                            ...
                            <td><a href="" onclick="timers(this.value);" style="text-decoration: none; font-size: x-large;">🏴</td>
                        </tr>
                        <?php
                    }
                    ?>
...
<script>
    function timers(test){
        ...
        xmlhttp.open("GET" , "start_timer.php?test=" + test,true );
        xmlhttp.send(null);
    }
</script>
